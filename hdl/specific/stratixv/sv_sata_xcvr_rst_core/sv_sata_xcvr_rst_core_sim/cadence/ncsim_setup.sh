...
TOP_LEVEL_NAME="sv_sata_xcvr_rst_core"
QSYS_SIMDIR="./../"
...
mkdir -p ./libraries/sv_sata_xcvr_rst_core/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_xcvr_reset_control/altera_xcvr_functions.sv"     -work sv_sata_xcvr_rst_core -cdslib ./cds_libs/sv_sata_xcvr_rst_core.cds.lib
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_xcvr_reset_control/alt_xcvr_resync.sv"           -work sv_sata_xcvr_rst_core -cdslib ./cds_libs/sv_sata_xcvr_rst_core.cds.lib
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_xcvr_reset_control/altera_xcvr_reset_control.sv" -work sv_sata_xcvr_rst_core -cdslib ./cds_libs/sv_sata_xcvr_rst_core.cds.lib
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_xcvr_reset_control/alt_xcvr_reset_counter.sv"    -work sv_sata_xcvr_rst_core -cdslib ./cds_libs/sv_sata_xcvr_rst_core.cds.lib
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/sv_sata_xcvr_rst_core.v"                                                                                                            
fi
